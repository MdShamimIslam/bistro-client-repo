    ...
    <div className="drawer lg:drawer-open">
      ...
      {/* <div className="drawer-side">
        ...
        <ul className="menu uppercase p-4 w-80 min-h-full bg-base-200 text-base-content">
          ...
          <li>
            <Link><i className="fa-solid fa-house"></i> Admin Home</Link>
          </li>
          <li>
            <Link><i className="fa-solid fa-microchip"></i> Add items</Link>
          </li>
          <li>
            <Link><i className="fa-solid fa-list"></i> Manage items</Link>
          </li>
          <li>
            <Link><i className="fa-solid fa-book"></i> Manage Bookings</Link>
          </li>
          <li>
            <Link><i className="fa-solid fa-users"></i> All Users</Link>
          </li>
          <div className="divider"></div>
          <li>
          ...
          <li>
            <Link to=''><i className="fa-solid fa-bars"></i>Menu</Link>
          </li>
          <li>
            <Link to=''><i className="fa-solid fa-briefcase"></i> Order</Link>
          </li>
          <li>
            <Link to=''><i className="fa-solid fa-envelope"></i> Contact</Link>
          </li>
